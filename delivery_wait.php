...
<head>
	<meta charset="utf-8">
	<title>FoodDeli - Chwila wytchnienia</title>
...
<div class="container pt-5">
	<div class="row pt-5">
      	...
      	<div class="w-100"></div>
      	<div class="col-12">
      		<h2 class='fluid bg-light text-center mb-0 pt-4 pb-3'>Czas na chwilę wytchnienia!</h2>
			<h2 class='fluid bg-light text-center mb-0 pb-3 lead'>Twoje nowe zlecenie pojawi się już wkrótce.</h2>
      	</div>
    </div>
 </div>
