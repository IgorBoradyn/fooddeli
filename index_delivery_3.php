...
<head>
	<meta charset="utf-8">
	<title>FoodDeli - Zamówienie</title>
...
<h2 class='fluid bg-light text-center mb-0 pt-4 pb-3'>Zamówienie</h2>
...
<div class="containe bg-light">
	<div class="row">
		...
		<div class="col-5" style="border-left: 1px solid #dee2e6;">
			<div class="row">
				<div class="col">
					<h3 class='fluid bg-light text-center mb-0 pt-3 pb-2 lead'>Trasa dostawy</h3>
				</div>
				<div class="w-100"></div>
				<div class="col">
				...
				<div class="col pt-5">
					<div class="text-center pb-3">
			  			<button type="button" class="btn border bordercolor resto shadow-none" data-toggle="modal" data-target="#exampleModalCenter" style="min-width: 210px;">Zakończ odbiór osobisty</button>
			  			<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  							<div class="modal-dialog modal-dialog-centered" role="document">
    							<div class="modal-content">
      								<div class="modal-header">
        								<h5 class="col-12 modal-title text-center" id="exampleModalLongTitle">Zakończ odbiór osobisty</h5>
      								</div>
	      							<div class="modal-content">
										<div class="container">
  											<div class="row">
    											<div class="col pt-4 pb-4">
													<button type="button" class="btn btn-success px-5 py-2" onclick="">Tak</button>
												</div>
    											<div class="col pt-4 pb-4">
										  			<button type="button" class="btn btn-danger px-5 py-2" data-dismiss="modal">Nie</button>
    											</div>
  											</div>
										</div>
	      							</div>
					...
					<div class="text-center">
			  			<button type="button" class="btn border bordercolor resto shadow-none" data-toggle="modal" data-target="#exampleModalCenter2" style="min-width: 210px;">Zakończ dostawę</button>
			  			<div class="modal fade" id="exampleModalCenter2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  							<div class="modal-dialog modal-dialog-centered" role="document">
    							<div class="modal-content">
      								<div class="modal-header">
        								<h5 class="col-12 modal-title text-center" id="exampleModalLongTitle">Zakończ dostawę</h5>
      								</div>
	      							<div class="modal-content">
										<div class="container">
  											<div class="row">
    											<div class="col pt-4 pb-4">
													<button type="button" class="btn btn-success px-5 py-2" onclick="location.href='index_delivery_1.php'">Tak</button>
												</div>
    											<div class="col pt-4 pb-4">
										  			<button type="button" class="btn btn-danger px-5 py-2" data-dismiss="modal">Nie</button>
    											</div>
...
<!-- <button type="button" class="btn border bordercolor resto shadow-none mb-3 rounded" style="background: rgb(234, 236, 239);" onclick="location.href='index_change_password.php'">Zakończ dostawę</button> -->
